...
\item {\bf S.~Du}, J.~Zhang, Y.~Li. Lagrangian flow matching: a least-action framework for principled path design.
...
element-type methods via machine learning, with applications to radiative transfer. {\sl J. Comput. Math. (2024)}.\\
...
\item 
{\bf S. Du}. HDG methods for the Stokes equation based on strong symmetric stress formulations. {\sl J. Sci. Comput. 85, 8 (2020)}.\\
...
\section{GRANTS}
\begin{cvitemize}
\item NSF (DMS–2608769): Efficient High-Order Methods for Radiative Transfer via Substructuring. PI. \$112,085 at Syracuse University (2026--2029).
\item NSF (AGS–2326631): Convective Processes in the Tropics Across Scales. Co-PI. \$768,471 total, \$471,155 at UW-Madison (2024--2027).
%\item NSF (DMS–2324368): Breaking the 1D Barrier in Radiative Transfer: Fast, Low-Memory Numerical Methods for Enabling Inverse Problems and Machine Learning Emulators. Senior personnel. \$498,832 total, \$350,000 at UW-Madison (2023--2026).
\end{cvitemize}
...
{\sl Mathematical Sciences Colloquium, Rensselaer Polytechnic Institute}
\hfill Mar 2026

\item
Accelerating finite element via machine learning on one element\\
{\sl Keynote, Winter Research Symposium, University of Delaware}
\hfill Feb 2026
...
{\sl 14th AIMS Conference, Abu Dhabi}
\hfill Dec 2024
...
\begin{cvitemize}
\item SOURCE Bridge Award mentorship, Syracuse University
\hfill 2026
